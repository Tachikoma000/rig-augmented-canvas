...
export interface InitOutput {
  ...
  readonly __wbg_rigcommand_free: (a: number, b: number) => void;
  readonly rigcommand_id: (a: number) => any;
  readonly rigcommand_set_id: (a: number, b: number, c: number) => void;
  readonly rigcommand_name: (a: number) => any;
  readonly rigcommand_set_name: (a: number, b: number, c: number) => void;
  readonly rigcommand_callback: (a: number) => void;
